    ...
    return (
        <footer className="neutral-bg-2">
            <div id="footer_social-links">
                <img className="social-icon" src={fbIconSrc} alt="link to my facebook" />
                <img className="social-icon" src={googleIconSrc} alt="link to my google account" />
                <img className="social-icon" src={linkedinIconSrc} alt="link to my LinkedIn" />
            </div>
            <div className="footer_section">
                <div className="decor-line" />
                <p>consectetur quis laboris. Aute laborum nisi nulla aliqua elit Lorem sit culpa reprehenderit aliqua anim proident eu. Ipsum officia dolor velit consectetur est excepteur do incididunt tempor qui dolor ipsum laboris tempor.</p>
            </div>
            <div className="footer_section">
                <div className="decor-line" />
